...
export default function Modal({ open, onClose, title, children, wide }: ModalProps) {
  ...
  return createPortal(
    ...
    >
      <div className={`bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-600 flex flex-col max-h-[85vh] ${wide ? 'w-[90vw] max-w-6xl' : 'w-[600px] max-w-[90vw]'}`}>
        {/* Header */}
